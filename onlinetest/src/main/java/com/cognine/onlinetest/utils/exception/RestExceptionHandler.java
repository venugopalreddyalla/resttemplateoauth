...
public class RestExceptionHandler extends ResponseEntityExceptionHandler {
	...
	/**
	 * Handles FailedToPersistException. Created to encapsulate errors with more
	 * detail.
	 *
	 * @param ex
	 *            the FailedToPersistException
	 * @return the ApiError object
	 */
	@ExceptionHandler(FailedToPersistException.class)
	protected ResponseEntity<Object> handleFailedToPersist(FailedToPersistException ex) {
