...
public class EntityNotFoundException extends Exception {
	...
	public EntityNotFoundException(String tableName, String... searchParamsMap) {
		super(EntityNotFoundException.generateMessage(tableName, toMap(String.class, String.class, searchParamsMap)));
	}
